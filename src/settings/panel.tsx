...
import { faCog, faDiceD20, faWindowRestore } from "@fortawesome/free-solid-svg-icons";
...
export function Panel() {
    ...
    const updateOverlay = () => {
        ...
        window.electron.send("poe-switch-overlay-status", !isOverlay);
    };
    ...
    return (
        <div className="absolute bottom-[200px] left-[300px] flex items-center">
            <div className="flex flex-row gap-x-2">
                ...
                >
                    <FontAwesomeIcon icon={faWindowRestore} className="h-6 w-6 text-gray-100" />
                </button> */}
            ...
            {/* {hotkeyHelperTextFeature.enabled && isOverlay && <span className="ml-2 text-sm rounded-md p-2 bg-opacity-70 bg-slate-800">Ctrl + F to enable overlay</span>} */}
